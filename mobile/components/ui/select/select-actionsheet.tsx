...
const actionsheetContentStyle = tva({
  base: "items-center rounded-tl-3xl rounded-tr-3xl py-2 px-5 bg-background-0 web:pointer-events-auto web:select-none shadow-lg pb-safe gap-1",
});

const actionsheetItemStyle = tva({
  base: "w-full flex-row items-center p-3 rounded-xl data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-background-50 active:bg-background-100 data-[focus=true]:bg-background-100 web:data-[focus-visible=true]:bg-background-100 data-[checked=true]:bg-background-100",
});
