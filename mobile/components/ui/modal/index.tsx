...
const modalBackdropStyle = tva({
  base: "absolute left-0 top-0 right-0 bottom-0 bg-background-0 web:cursor-default",
});

const modalContentStyle = tva({
  base: "bg-background-0 rounded-md overflow-hidden border border-secondary-200 shadow-hard-2 p-6 rounded-3xl",
  parentVariants: {
    size: {
      xs: "w-[60%] max-w-[360px]",
      sm: "w-[70%] max-w-[420px]",
